...
; (function (globalScope) {
    ...
    P.compareTo = P.cmp = function (other) {
        ...
        if (this.layer > other.layer) r = 1
            ...
            var e, f;
            for (var i = 1, l = Math.min(this.array.length, other.array.length); i < l; ++i) {
                e = this.array[this.array.length - i];
                f = other.array[other.array.length - i];
                if (e[3] > f[3] || (e[3] == f[3] && (
    ...
    P.normalize = function () {
        ...
        do {
            ...
            if (x.array.length > PowiainaNum.maxOps) x.array.splice(0, x.array.length - PowiainaNum.maxOps); // max operators check
